...
const Attendence = () => {
  ...
  return (
    ...
    <div className="main  p-10  flex justify-between">
      <div className="students w-10/12 flex" >
        <div
          className="circle bg-blue h-16 w-16 flex justify-center items-center mr-4"
          style={{ borderRadius: "90rem", background: "#5C93FA" }}
        >
          <svg
        ...
        <div className="head mt-2 text-4xl font-medium text-gray-900 dark:text-dark">Attendence</div>

      </div>
    

     {/* <div className="btn">
            <button>Add Studnets</button>
            </div> */}
